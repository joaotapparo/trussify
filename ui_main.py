...
#endif // QT_CONFIG(shortcut)
        self.actionAbout.setText(QCoreApplication.translate("MainWindow", u"About trussify", None))
...
"", None))
        ...
        #menu in the top bar
        self.label.setText(QCoreApplication.translate("MainWindow", u" trussify", None))
